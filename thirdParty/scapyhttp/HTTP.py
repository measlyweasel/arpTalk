...
#thanks to https://github.com/invernizzi/scapy-http for providing scapy http support

#Copyright (C) 2012 Luca Invernizzi <invernizzi.l@gmail.com> and Steeve Barbeau
#<http://www.sbarbeau.fr>
#
